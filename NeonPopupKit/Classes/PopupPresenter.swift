...
public enum PopupPresenter {
    ...
    public static func show(_ view: UIView & PopupPresentable, in parent: UIView, config: PopupConfiguration, completion: (() -> Void)? = nil) {
    ...
    public static func dismiss(_ view: UIView & PopupPresentable, completion: (() -> Void)? = nil) {
    ...
    ///   - completion: 弹窗关闭完成后的回调
    public static func dismiss(in parent: UIView, matching target: DismissTarget = .first, completion: (() -> Void)? = nil) {
        switch target {
        case .first:
